...
public class SetPinActivity extends AppCompatActivity {
    ...
    public void onClick(Button button) {
       ...
       // Toast.makeText(this, pin, Toast.LENGTH_SHORT).show();
        if (codeString.length() == MAX_LENGHT) {
            ...
            Intent intent = new Intent(SetPinActivity.this, ConformPinActivity.class);
            startActivity(intent);
            MyFunctions.setSharedPrefs(SetPinActivity.this, Constants.SETPIN, pin);
            finish();
    ...
    public void back(View view) {
        ...
        intent.setClass(SetPinActivity.this, ActivityAccountList.class);
        startActivity(intent);
    }

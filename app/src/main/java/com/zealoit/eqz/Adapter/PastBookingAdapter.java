...
public class PastBookingAdapter extends RecyclerView.Adapter<PastBookingAdapter.PastBookingViewHolder> {
    ...
    private List<PastbookingList> pastbookingLists;
    ...
    public PastBookingAdapter(Context mCtx, List<PastbookingList> pastbookingLists) {
        this.mCtx = mCtx;
        this.pastbookingLists = pastbookingLists;
    }
    ...
    @Override
    public void onBindViewHolder(final PastBookingViewHolder holder, int position) {
        //getting the product of the specified position
        final PastbookingList getAllProviderList = pastbookingLists.get(position);
    ...
    public int getItemCount() {
        return pastbookingLists.size();
    }


    class PastBookingViewHolder extends RecyclerView.ViewHolder {
        ...
        android.widget.ImageView ImageView , img_images , img_image_up , pdf_imge;


        public PastBookingViewHolder(View itemView) {
            super(itemView);

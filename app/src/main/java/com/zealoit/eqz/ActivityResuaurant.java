...
public class ActivityResuaurant extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final HelpDeskAdapter adapter = new HelpDeskAdapter(ActivityResuaurant.this,getSupportFragmentManager(), tabLayout.getTabCount());
        ...
        // create class object
        gps = new GPSTracker(ActivityResuaurant.this);
        ...
        if(gps.canGetLocation()){
            ...
            Geocoder geocoder = new Geocoder(ActivityResuaurant.this, Locale.getDefault());
            try {
    ...
    public void back(View view) {
        ...
        intent.setClass(ActivityResuaurant.this, HomeActivity.class);
        startActivity(intent);
    }

    public void location(View view) {
        Intent intent = new Intent();
        intent.setClass(ActivityResuaurant.this, ActivityLocationName.class);
        startActivity(intent);
    }
    ...
    protected void selectFragment(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_loudspeaker:
                Intent intent = new Intent(ActivityResuaurant.this, HomeActivity.class);
                startActivity(intent);
                break;

            case R.id.action_user:
                Intent intent2 = new Intent(ActivityResuaurant.this, ActivityAccountList.class);
